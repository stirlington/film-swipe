...
# Define the user's shortlist
shortlist = []

# Define the user's matches
matches = []

# Define the user's selection
selection = []

# Define the user's debate
debate = []

# Define the user's current film
current_film = None

# Define the user's current genre
current_genre = None

# Define the user's current action
current_action = None

# Define the user's current romance
current_romance = None

# Define the user's current comedy
current_comedy = None

# Define the user's current thriller
current_thriller = None

# Define the user's current horror
current_horror = None

# Define the user's current drama
current_drama = None

# Define the user's current critically acclaimed
current_critically_acclaimed = None

# Define the user's current shortlist
current_shortlist = []

# Define the user's current matches
current_matches = []

# Define the user's current selection
current_selection = []

# Define the user's current debate
current_debate = []
